...
9. ❌ ~~Formulaire de contact envoyé via EmailJS (service cloud tiers)~~ — remplacé par un lien `mailto:` préempli (nom, email, message), voir ADR-0002. Réaffirme la contrainte "Zéro dépendance externe" ci-dessus.
